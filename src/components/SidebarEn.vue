  ...
  >
    <div class="container-fluid">
      ...
      <a class="navbar-brand pt-0" href="./index.html">
        <img
          src="@/assets/img/brand/Logo_original.svg"
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link " href="./accounts.html">
              <i class="ni ni-credit-card text-red"></i> Accounts
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link " href="./clients.html">
              <i class="ni ni-circle-08 text-red"></i> Clients
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link " href="./examples/profile.html">
              <i class="ni ni-single-copy-04 text-red"></i> Invoices
            </a>
          </li>
          <li class="nav-item">
